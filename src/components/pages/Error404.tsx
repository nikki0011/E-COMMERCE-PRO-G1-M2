...
const Error404 = () => {
  return (
    <div className=" container flex flex-col justify-center items-center gap-7 my-7">
      ...
      <Link
        to={"/"}
        className=" text-2xl text-stone-100 bg-neutral-600 p-3 rounded-tr-4xl rounded-bl-4xl hover:underline"
      >
        Volver a inicio
      </Link>
    </div>
